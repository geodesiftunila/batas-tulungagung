...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sistem Informasi Geospasial Dusun Tulungagung 1, Pekon Tulungagung, Kecamatan Gadingrejo, Kabupaten Pringsewu</h2>';
        return titleElement;
    })(),
